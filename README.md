<div align="center" style="background: linear-gradient(135deg, #1E3A8A, #3B82F6); padding: 40px; border-radius: px; color: white; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);">
