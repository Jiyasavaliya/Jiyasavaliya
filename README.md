<div align="center" style="background: linear-gradient(135deg, #1E3A8A, #3B82F6); padding: 40px; border-radius: 15px; color: white; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);">
  <h1 style="font-size: 8em; font-weight: 30000;">👋 Hello, I'm Jiya Savaliya!</h1>
  <p style="font-size: 6em; font-weight: 15800;">🔍 Data Science Enthusiast | 💻 Developer | 📊 Problem Solver</p>
</div>
